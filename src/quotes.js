const myJSON = [
	...
	"He's a real piece of shit. - Rick",
	"I'm not looking for judgement, just a yes or no. Can you assimilate a giraffe? - Rick",
	"We need a hang glider, and a crotch less uncle sam costume, and I want the entire field of your largest stadium covered end to end with naked red heads, and I want the stands packed with every man that remotely resembles my father. - Rick",
	...
	"There is no god, in your face! One dot muthafucka! - Rick",
	"Not today bitch! - Rick",
	"That guy is the Red Grin Grumbold of pretending he knows what's going on... Oh you agree huh? You like that Red Grin Grumbold reference? Well guess what, I made him up. You really are your father's children. Think for yourselves, don't be sheep. - Rick",
	"Yo! What up my glip glops! - Rick",
	...
	"25 shmeckles? I-I-I-I don't even know what that- what is that? Is that a lot? - Rick",
	"ALLAH BLEHHHH AKBAR - Rick",
	...
	"I mixed in some Praying Mantis DNA. You know a Praying Mantis is the exact opposite of a Vole, Morty? They mate once and then bluergh cut each other's heads off. - Rick",
	...
	"its fine, everythings is fine. theres an infinite number of realities morty, and in a few dozens of those i got lucky and turned everything back to normal - Rick",
	"its not like we can do this every week, we get 3 or 4 more of these tops - Rick",
	'"Lemme hear everybody say hey-yo! All the ladies say yeaaah! Everybody over thirty do this with your hand! Everybody with a red shirt jump up and down! Yo, everyone whose first name begins with an L who isn\'t hispanic, walk in a circle the same number of times as the square root of your age times teeenn!" - Rick',
	...
	'"Puffy vagina" - Rick',
	'"Morty, can you get to the left nipple?" - Rick',
	'"Not for the men they cheat on." - Rick',
	'sings "Baker Street" sax solo* - Rick',
	'"Sometimes science is a lot more art, than science. A lot of people don\'t get that." - Rick',
	'"That\'s Right Morty! This is gonna be a lot like that. Except you know. Its gonna~Belch~ make sense." - Rick',
	...
	"they're not infinite universes left in sync with the show, - Rick",
	...
	"We're gonna nine eleven this bitch unless Morty gets better math grades! - Rick",
	...
	"What are you looking at, mother fucker! - Rick",
	'"What just happened back there?" "Why don\'t you ask the smartest people in the universe, Jerry? Oh yeah belch you can\'t. They blew up." - Rick',
	...
	'"You don\'t have to try to impress me Morty." - Rick',
	...
	"\"You're growing up fast, Morty. You're going into a great big thorn straight into my ass...\" - Rick",
	...
	"I can finally go on that trip I've been talking about. - Beth",
	"I don't know man, Italy, Greece, Argentina... - Beth",
	"If it were, you could call ME Ernest Hemingway. - Beth",
	"5 more minute of this and I'm going to get mad! - Goldenfold",
	"Why would I negotiate with you?! Rick: Because we are both rational adults who don't want anything bad to happen. And because I have a human shield. - Goldenfold",
	'"Morty! The principal and I have discussed it, a-a-and we\'re both insecure enough to agree to a three-way!" - Goldenfold',
	"Nice, Mrs Pancakes. Real nice. - Goldenfold",
	"Nice one, Ms Pancakes. - Goldenfold",
	"'Nice to wheat you!' - Goldenfold",
	"Then let me GET to know you! - Goldenfold",
	...
	"This aftershave made women want me, but it also made me impotent! - Goldenfold",
	...
	"are you hungry for apples? ARE YOU HUNGRY FOR APPLESSS!? - Jerry",
	...
	"I wish that shotgun was my penis. - Jerry",
	"(in an impression of Johnny Carson's Carnac the Magnificent): Countries known for their sexually aggressive men... - Jerry",
	'"I wish that shotgun was my penis." - Jerry "If it was, you could call me Ernest Hemingway." - Beth',
	'"So woman like confidence... How convenient..." - Jerry',
	...
	"Did you just come in through a portal? - Jessica",
	"HI! I'M MR MEESEEKS! LOOK AT ME! - Meeseeks",
	"Cause he roped me into this! - Meeseeks",
	"Existence is pain to a meeseeks Jerry, and we will do anything to alleviate that pain. - Meeseeks",
	"Dont look at me! that guy over there...roped ME into this - Meeseeks",
	"I JUST WANNA DIE! - Meeseeks",
	"I'm a bit of a stickler Meeseeks, what about your short game? - Meeseeks",
	"Meeseeks don't usually have to exist for this long. It's gettin' weeeiiird... - Meeseeks",
	"Meeseeks were not born into this world fumbling for meaning, Jerry! - Meeseeks",
	'"Is he keeping his shoulders square?" "Oooooooh he\'s tryin\'!" - Meeseeks',
	"Oh, we're welllll past that, JERRY! - Meeseeks",
	"Ooohhh can do. - Meeseeks",
	'"Whats your name mamm?" - Meeseeks',
	"WHY'D YOU EVEN ROPE ME INTO THIS! - Meeseeks",
	"We ALL wanna die, we're meeseeks! - Meeseeks",
	"We are created to serve a singular purpose, for which we will go to any lengths to fulfill! - Meeseeks",
	"Well he roped ME into this! - Meeseeks",
	"Your failures are your own, old man! I say, FOLLOW THROOOOUGH! - Meeseeks",
	"Well then get your shit together. Get it all together and put it in a backpack, all your shit, so it's together. ...and if you gotta take it somewhere, take it somewhere ya know? Take it to the shit store and sell it, or put it in a shit museum. I don't care what you do, you just gotta get it together... Get your shit together. - Morty",
	"Aw, c'mon Rick. That doesn't seem so bad. - Morty",
	"Aww, gee, you got me there, Rick. - Morty",
	"Don't be trippin dog we got you - Morty",
	...
	'"You\'re talking about Inception?" - Morty',
	'"Nobody exists on purpose. Nobody belongs anywhere. Everybody\\u2019s gonna die. Come watch TV?\\u201d - Morty',
	'"This is Principal Vagina. No relation." - Pilot - Principal Vagina',
	'"...and there\'s NO EVIDENCE that a Latino student did it." - Pilot - Principal Vagina',
	'"If anything happened to you I would kill myself! I love you bad, bobo!" - Rick Potion No. 9 - Principal Vagina',
	"\"Principal Vagina here, don't let the name fool you; I'm very much in charge. Reminding you that tonight is our annual flu season dance. I don't know how many times I have to say this, but if you have the flu, stay home. The flu season dance is about awareness, not celebration. You don't bring dead babies to Passover.\" - Rick Potion No. 9 - Principal Vagina",
	'"Hi! Principal Vagina: the name\'s real, possibly Scandinavian." - Get Schwifty - Principal Vagina',
	"Awww, bitch! - Scary Terry",
	"Awww, it's you guys! - Scary Terry",
	"Awwww thanks, bitch! - Scary Terry",
	'"I\'M YOUR WORST NIGHTMARE, BITCH!" - Scary Terry',
	'"THIS IS BECAUSE YOU GIVE MORTY SMITH BAD GRADES, BITCH!" - Scary Terry',
	'"Oh no. I\'m late to class, bitch." - Scary Terry',
	"You can run, but you can't hide BITCH! - Scary Terry",
	"These 2 halves don't belong together, bitch! - Scary Terry",
	"Hello Jerry, come to rub my face in urine again? - Snuffles/Snowball",
	"Snuffles was my slave name, you can call me snowball because my fur is pretty and white. - Snuffles/Snowball",
	"Where are my testicles, Summer? - Snuffles/Snowball",
	"Snuffles want to be understood. Snuffles need to be understood. - Snuffles/Snowball",
	...
	"Oh, wow. That's an intense line of questioning, Snuffles - Summer",
	"I'm the Devil, what should I do when I fail? Give myself an ice cream? - Mr. Needful (The Devil)",
	"A price for everything - Mr. Needful (The Devil)",
	"I'd like to order one large person with extra people please. white people, no no no black people... and hispanic on half. - Other Characters",
	"I'd like to order one large sofa chair with extra chair please. high chair, no no no recliner... and wheelchair on half. - Other Characters",
	"I'd like to order one large phone with extra phones please. cell phone, no no no rotary... and payphone on half. - Other Characters",
	"Alien Invasion Tomato Monster Mexican Armada Brothers Who Are Just Regular Brothers Running In A Van From An Asteroid And All Sorts Of Things: The Movie - Other Characters",
	'"And now, human music." boop beep boop... boop beep boop... - Other Characters',
	"dont mind those stare goblins - Other Characters",
	"I am Mr. Booby Buyer. I'll buy those boobies for 25 schmeckles! - Other Characters",
	'I love morty and i hope morty loves me. I want to wrap my arms around him and feel him deep inside me" - Other Characters',
	"I do not have dis-colored butthole flaps. - Other Characters",
	"Lookin' good! - Other Characters",
	"My man! - Other Characters",
	'"My name is Slip- Slippery Stair. I\'ll take ya down there for 25 SHMECK-ELS!" - Other Characters',
	'"Puh rum pum pow!" - Other Characters',
	"Slow down! - Other Characters",
	'"S-S-Samantha." - Other Characters',
	"That's stupid-SMASH - Other Characters",
	'"Prepare to be emancipated from your own inferior genes!" - Other Characters',
];
